...
import { CheckCircle2, Instagram, Linkedin, Mail, Home, Info, Phone, Briefcase, History } from "lucide-react";
        ...
        <div className="bg-slate-900/90 backdrop-blur-xl rounded-3xl p-2 shadow-2xl shadow-slate-900/40 border border-white/10 flex items-center justify-around">
          {[
            ...
            <Link
              key={item.label}
              href={item.href}
              className={`flex flex-col items-center gap-1 px-3 py-2 rounded-2xl transition-all duration-300 ${item.href === '/contact'
